...
async function collectMediaData(onStatus) {
  ...
  const mediaSlots = ['midi', 'audio', 'skyDome', 'innerSky', 'floor', 'floor2', 'floor3', 'leftWall', 'centerWall', 'rightWall', 'backWall', 'panel5Wall', 'panel6Wall', 'heightmap', 'heightmap2', 'heightmap3', 'glb', 'plyBg0', 'plyBg1', 'plyBg2'];
